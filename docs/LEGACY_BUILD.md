# Legacy upstream build instructions

These instructions were inherited from Nulloy and are retained as historical
reference. They describe the Qt 5/qmake build, including the old Windows 32-bit
toolchain. They are not the supported build path for this fork's portable alpha,
and have not been revalidated for current Linux or macOS systems.

Use the [current fork build instructions](../README.md#building-the-fork) instead.
