...
## Nachtrag 2026-09-11: reviewed native timeout contracts and PR30 status

The independently reviewed Windows supervisor/Qt-fixture contract run [34595596113](https://github.com/Auda29/nulloy/actions/runs/34595596113) passed on branch `test/windows-uia-timeout-native`, with supervisor `68cdc90f369d6c5f507c81cf757befb509dbfeb9`, harmless fixture `b7d228e885841cb796ed9d31fa79526864dba031`, and assembled native commit `ca49815db8db16b8704cc82f89336e09f8ed2d70`. The Windows-2022 environment reported Windows-10-10.0.20348-SP0, Python3.11.9, PySide6/Qt6.8.2, and psutil7.0.0. The supervisor discovered 18 tests: 16 passed and two explicitly POSIX-only cases skipped. The harmless real Qt fixture passed all four tests with no skips.

The five runtime Python script hashes were verified with LF/CRLF allowance in the parent report. This milestone contains no Nulloy/player package and did not execute an actual UIA target query. The invalid-HWND (`0`) guard rejects before querying; synthetic PID races are contract mocks, not native UIA evidence. Therefore it proves Windows process supervision and the harmless Qt fixture only. COM/provider query execution remains `not_executed`; no player, menu, input, recycling, or final acceptance follows from this run. A parallel controller has no result recorded here.

The exact PR30 live snapshot fetched at `2026-09-11T11:50:53.817380+00:00` records OPEN/DRAFT head `c2405a0375b23dfdc3561a5bdd7a1eb56a812902`. Windows Qt5/Qt6 run `34588893748` and Linux run `34588893721` both succeeded for that head. They remain CI-branch results only: no fresh PR30 package hash acceptance and no combined end-package claim. Integration is still `919468efc32f4d038c96d7276a799794dab2e86e`; `master` is still `027d81a583b07457a4fa5f18b3e7dcca50b05b58`; the serial Windows matrix was not changed.

## Nachtrag 2026-09-11: 60-test player observation
